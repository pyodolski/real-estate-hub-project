...
| 17.1.1 |        |  | 사용자가 즐겨찾기한 매물이 거래 완료되었을 경우, 사용자에게 ‘찜한 매물 거래 완료’ 알림을 전송한다. |  |  |  | 30.3.1 | H |  |
| 17.1.2 |        |  | 사용자가 즐겨찾기한 매물의 가격이 하락했을 경우, 사용자에게 ‘찜한 매물 가격 하락’ 알림을 전송한다. |  |  |  | 30.3.1 | H |  |
| 17.1.3 |        |  | 매물 추천 알고리즘에 의해 조건을 만족하는 매물이 새로 등록되었을 경우, 사용자에게 ‘새로운 추천 매물’ 알림을 전송한다. |  |  |  | 40.1.8 | H |  |
| 17.1.4 |        |  | 사용자가 설정한 예산 범위에 해당하는 매물이 등록되었을 경우, 사용자에게 ‘가격 알림 설정 도달’ 알림을 전송한다. |  |  |  | 33.1.1 | H |  |
| 17.1.5 |        |  | 관리자가 소유자가 보유한 매물의 승인 요청을 수락했을 경우, 사용자에게 ‘계약서 검토 완료’ 알림을 전송한다. |  |  |  | 7.1.3 | H |  |
| 17.1.6 |        |  | 사용자가 구매 중인 매물의 중개인이 거래 완료 처리를 했을 경우, 사용자에게 ‘구매 완료’ 알림을 전송한다. |  |  |  | 18.1.2 | H |  |
...
| 17.2.4 |        |  | 네트워크 오류로 알림을 불러오지 못할 경우, 캐시된 알림을 먼저 보여주고 ‘동기화 실패’ 안내가 표시된다. |  |  |  |  | H |  |
| 17.2.5 |        |  | 찜한 매물 거래 완료 알림을 통해 사용자는 즐겨찾기한 매물이 거래 완료되었음을 확인할 수 있다. |  |  |  | 17.1.1 | H |  |
| 17.2.6 |        |  | 찜한 매물 가격 하락 알림을 통해 사용자는 즐겨찾기한 매물의 가격이 하락했음을 확인할 수 있다. |  |  |  | 17.1.2 | H |  |
| 17.2.7 |        |  | 새로운 추천 매물 알림을 통해 추천 매물 리스트에 신규 매물이 추가되었음을 확인할 수 있다. |  |  |  | 17.1.3 | H |  |
| 17.2.8 |        |  | 가격 알림 설정 도달 알림을 통해 사용자가 설정한 예산 범위에 해당하는 매물이 등록되었음을 확인할 수 있다. |  |  |  | 17.1.4 | H |  |
| 17.2.9 |        |  | 계약서 검토 완료 알림을 통해 사용자는 자신이 소유한 매물이 관리자에 의해 승인되었는지를 확인할 수 있다. |  |  |  | 17.1.5 | H |  |
| 17.2.10|        |  | 구매 완료 알림을 통해 사용자는 자신이 구매 중이던 매물이 거래 완료되었음을 확인할 수 있다. |  |  |  | 17.1.6 | H |  |
|   18   |평점 기능|                                     ||||||     |       |
