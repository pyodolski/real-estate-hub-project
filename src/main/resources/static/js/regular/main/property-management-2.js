...
(function() {
  ...
  if (typeof window.PropertyManagement === 'undefined') {
    console.error('[Part 2] PropertyManagement class not found. Load part-1.js first.');
    return;
  }

  // 여기에 추가 메서드들을 prototype에 추가할 수 있습니다
  // 예: PropertyManagement.prototype.someNewMethod = function() { ... };

  console.log('[PropertyManagement Part 2] Loaded');
})();
